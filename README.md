...
Includes rich test reporting powered by [Allure](https://github.com/allure-framework/allure2).
...
Reports are automatically published to GitHub Pages: [Latest test results](https://andgineer.github.io/e2e-tests/builds/tests/).
